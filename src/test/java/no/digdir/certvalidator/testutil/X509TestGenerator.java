package no.digdir.certvalidator.testutil;
...
public class X509TestGenerator {
    ...
    public X509Certificate createX509Certificate(X509Certificate issuer, String subject, X509ExtensionCustom custom, Date from, Date to) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CertificateException, OperatorCreationException, CertIOException {
    ...
    public X509Certificate createX509Certificate() throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CertificateException, OperatorCreationException, CertIOException {
        return createX509Certificate(toDate(ZonedDateTime.now(ZoneId.systemDefault()).minusYears(1)), toDate(ZonedDateTime.now(ZoneId.systemDefault()).plusYears(1)));
    }

    public X509Certificate createX509Certificate(String s) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CertificateException, OperatorCreationException, CertIOException {
        return createX509Certificate(s, null, toDate(ZonedDateTime.now(ZoneId.systemDefault()).minusYears(1)), toDate(ZonedDateTime.now(ZoneId.systemDefault()).plusYears(1)));
    }

    public X509Certificate constructCertWithCertificatePolicie(final String policie) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CertificateException, CertIOException, OperatorCreationException {
